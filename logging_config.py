...
def log_config_operation(operation: str, config_id: str, version: Optional[int] = None, **kwargs) -> None:
    """
...
def log_database_operation(collection: str, operation: str, duration_ms: Optional[int] = None, **kwargs) -> None:
    """
...
def log_webhook_dispatch(webhook_url: str, event_type: str, success: bool, attempt: int = 1, **kwargs) -> None:
    """
...
def log_authentication_event(event_type: str, username: Optional[str] = None, success: bool = True, **kwargs) -> None:
    """
